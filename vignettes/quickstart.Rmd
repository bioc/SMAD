...
```{r CompPASSplus output figure, echo=FALSE, fig.height=7, fig.width=7, message=FALSE, warning=FALSE, paged.print=FALSE}

plot(sort(scoreCompPASSplus$scoreWD, decreasing = TRUE), pch = 16,
     xlab = "Ranked bait-prey interactions",
     ylab = "CompPASS-plus WD-score")
